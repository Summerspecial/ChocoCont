#Install-ChocolateyPackage 'subtitleedit' 'exe' '/verysilent' 'https://subtitleedit.googlecode.com/files/SubtitleEdit-3.3.13-Setup.zip'
try {
    $url = 'https://github.com/SubtitleEdit/subtitleedit/releases/download/3.3.13/SubtitleEdit-3.3.13-Setup.zip'
    $installer = 'SubtitleEdit-3.3.13-Setup.exe'
