#Install-ChocolateyPackage 'subtitleedit' 'exe' '/verysilent' 'https://subtitleedit.googlecode.com/files/SubtitleEdit-3.3.14-Setup.zip'
try {
    $url = 'https://github.com/SubtitleEdit/subtitleedit/releases/download/3.3.14/SubtitleEdit-3.3.14-Setup.zip'
    $installer = 'SubtitleEdit-3.3.14-Setup.exe'
