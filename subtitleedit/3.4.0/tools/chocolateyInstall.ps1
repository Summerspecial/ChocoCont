#Install-ChocolateyPackage 'subtitleedit' 'exe' '/verysilent' 'https://subtitleedit.googlecode.com/files/SubtitleEdit-3.4.0-Setup.zip'
try {
    $url = 'https://github.com/SubtitleEdit/subtitleedit/releases/download/3.4.0/SubtitleEdit-3.4.0-Setup.zip'
    $installer = 'SubtitleEdit-3.4.0-Setup.exe'
